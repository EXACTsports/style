        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('colours')" :active="request()->routeIs('colours')">
                        {{ __('Fonts & Colours') }}
                    </x-nav-link>
                    <x-nav-link :href="route('headings')" :active="request()->routeIs('headings')">
                        {{ __('Headings') }}
                    </x-nav-link>
                    <x-nav-link :href="route('tables')" :active="request()->routeIs('tables')">
                        {{ __('Tables') }}
                    </x-nav-link>
                    <x-nav-link :href="route('buttons')" :active="request()->routeIs('buttons')">
                        {{ __('Buttons & Links') }}
                    </x-nav-link>
                    <x-nav-link :href="route('inputs')" :active="request()->routeIs('inputs')">
                        {{ __('Inputs') }}
                    </x-nav-link>
                </div>
            </div>
